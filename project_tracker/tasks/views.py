...
from .forms import FeedbackForm, ProjectForm
...
class TaskCreateView(CreateView):
    ...
    def get_success_url(self):
        return reverse(
            "tasks:project_detail", kwargs={"project_id": self.kwargs["project_id"]}
        )
...
class TaskDeleteView(DeleteView):
    ...
    def get_success_url(self):
        return reverse_lazy(
            "tasks:project_detail", kwargs={"project_id": self.object.project.id}
        )
